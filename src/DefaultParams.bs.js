...
function payment(principal, apr, yearsOpt, param) {
  var years = yearsOpt !== undefined ? yearsOpt : 30;
...
var amount = payment(10000.0, 5.0, undefined, undefined);

console.log("Anount per month for loan 1: $", amount.toFixed(2));

var amount$1 = payment(25000.0, 7.5, 15, undefined);
